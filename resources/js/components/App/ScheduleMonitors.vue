<template>
    <div class="card card-default card-no-padding">
        <div class="card-header">
            <button class="btn btn-primary float-right" @click="showCreateForm = true" :disabled="showCreateForm">Create Schedule Monitor</button>
            Schedule Monitors
        </div>
        <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="monitor in monitors.data" :key="monitor.id">
                            ...
                            <td>
                                <a href="#" class="text-muted" @click.prevent="deleteMonitor(monitor)">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
