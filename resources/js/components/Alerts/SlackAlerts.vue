...
export default {
    ...
    methods: {
        ...
        deleteSlackAlert(slackAlert) {
            if (!confirm('Are you sure you want to delete this slack alert?')) {
                return;
            }

            axios.delete(`/api/slack-alerts/${slackAlert.id}`)
                .then(() => {
                    this.getSlackAlerts();
                });
        }
